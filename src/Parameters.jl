Base.@kwdef mutable struct Parameters
    ...
    ϵ_s::Float64 = 1.e-10 # termination tolerance
    m_L::Float64 = 1.e-6 #1.e-4 # serious step condition parameter (0, 0.5)
    ...
    max_age::Int = 30        # maximum number of iterations before removing inactive cuts

    # Trust region method
    Δ_ub::Float64 = 1.e+4 # trust region bound upper limit
