...
pm = BM.ProximalMethod(n, N, evaluate_f) #, init=x_init)
...
CSV.write("/Users/parshakova.tanya/Documents/Distributed_Optimization/BundleMethod/examples/jl_prox_fx0.csv",  
